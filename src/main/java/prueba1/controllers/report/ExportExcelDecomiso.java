...
public class ExportExcelDecomiso {
    public static ByteArrayInputStream listToExcelFile(List<Decomiso> decomisos, Reporte reporte) {
        try(Workbook workbook = new XSSFWorkbook()){
            Sheet sheet = workbook.createSheet("DECOMISOS");
            if (decomisos.size()!=0){
                ...
                celda.setCellValue("REPORTE DECOMISO");
                ...
                if (reporte.getCodUni()!=null){
                    ...
                    celda.setCellValue("Unidad Operativa: "+decomisos.get(0).getCod_uniOpe().getNom_uniOpe());
                    celda.setCellStyle(heads2);
                }
                ...
                for(int i = 0; i < decomisos.size(); i++) {
                    ...
                    dataRow.createCell(4).setCellValue(decomisos.get(i).getCod_tipoHoja().getNombre());
                    dataRow.createCell(5).setCellValue(decomisos.get(i).getCantidadNeta());
                }
